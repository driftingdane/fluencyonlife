...
class Users extends Base
{
    ...
    {
        $nation = $this->userModel->countries();
        // Init data
        $data = [
            'first' => '',
            'last' => '',
    ...
    public function confirm_reg()
    {
        ...
        $first = $valid_token->us_first;
        $last = $valid_token->us_last;
        $nation = $valid_token->us_lang;
        $slug = $valid_token->us_slug;
        $isStudentOrTeacher = $valid_token->has_access;
