                            ...
                            <form class="icon-form" action="<?php echo URLROOT; ?>/admins/socials" method="post">
                                ...
                                <div class="form-group">
                                    <label for="scFacebook">
                                        <p><i class="fab fa-facebook formIcons"></i> Facebook: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scTwitter">
                                        <p><i class="fab fa-twitter formIcons"></i> Twitter: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scLinkedin">
                                        <p><i class="fab fa-linkedin-in formIcons"></i> Linkedin: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scGoogle">
                                        <p><i class="fab fa-google formIcons"></i> Google: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scYoutube">
                                        <p><i class="fab fa-youtube formIcons"></i> Youtube: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scInstagram">
                                        <p><i class="fab fa-instagram formIcons"></i> Instagram: </p></label>
                                ...
                                <div class="form-group">
                                    <label for="scQuora">
                                        <p><i class="fab fa-quora formIcons"></i> Quora: </p></label>
