                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-4">
                        <div class="wrapper count-title d-flex align-items-center justify-content-center">
                            ...
                            <div class="name"><strong class="text-uppercase">New <span class="text-info">Topics</span></strong><span>Last 7 days</span>
                                <div class="count-number">
                                    <?php
                                    foreach ($data['countTopics'] as $count) :
                                        echo $count->tp;
                                    endforeach;
                                    ?>
                                </div>
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-4">
                        <div class="wrapper count-title d-flex align-items-center justify-content-center">
                            ...
                            <div class="name"><strong class="text-uppercase">New <span class="text-info">Questions</span></strong><span>Last 7 days</span>
                                <div class="count-number">
                                    <?php
                                    foreach ($data['countQuestions'] as $count) :
                                        echo $count->qs;
                                    endforeach;
                                    ?>
                                </div>
