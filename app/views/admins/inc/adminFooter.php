...
<script>
    $('.reports').DataTable({
        ...
        responsive: true,
        buttons: [
            { extend: 'copyHtml5', className: 'bg-info border-info btn-sm' },
            { extend: 'excelHtml5', className: 'bg-info border-info btn-sm' },
            { extend: 'pdfHtml5', className: 'bg-info border-info btn-sm' },
            { extend: 'csvHtml5', className: 'bg-info border-info btn-sm' }

        ]
    } );

    function myFunction() {
        let x = document.getElementById("hideBTN");
