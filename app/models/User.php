...
class User {
   ...
   public function register($data){
       $this->db->query('INSERT INTO users (us_first, us_last, us_email, us_pass, us_token, us_lang, has_access) VALUES (:first, :last, :email, :password, :tokenKey, :country, :hasAccess) ');
       // Bind values
   ...
   public function setUserSlug($urlHash, $lastid)
   {
       $this->db->query('UPDATE users SET us_slug = :urlHash WHERE us_id = :lastid');
       // Bind values
       $this->db->bind(':lastid', $lastid);
   ...
   public function countries(){
       $this->db->query('SELECT * FROM countries ORDER BY num_code ASC');
